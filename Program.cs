...
static string Seminar_1_Task_08(int Num) {
    ...
    return ResultStr;
          ...
          // Команды для выполнения задачи 8 (вынести вниз за тело функции и запустить на выполнение)
Console.WriteLine("Введите натуральное число:");
int N = Convert.ToInt16(Console.ReadLine());
Console.WriteLine($"Между 1 и {N} расположены (включительно) следующие четные числа:");
Console.WriteLine(Seminar_1_Task_08(N));
          // Команды для выполнения задачи 8        
